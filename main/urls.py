...
urlpatterns = [
    ...
    path("result/<str:pk>/config_snapshot", suite_result.config_snapshot, name="suite_config_snapshot"),
    ...
    path("case_result/<str:pk>/data_set_snapshot", case_result.data_set_snapshot, name="case_data_set_snapshot"),
