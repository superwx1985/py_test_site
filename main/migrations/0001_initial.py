    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('error_handle', models.IntegerField(choices=[(0, '继承上级'), (1, '中止测试'), (2, '继续测试'), (3, '暂停测试'), (4, '跳过步骤')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('result_state', models.IntegerField(blank=True, choices=[(0, '跳过'), (1, '成功'), (2, '失败'), (3, '异常'), (4, '中止')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('error_handle', models.IntegerField(choices=[(1, '中止测试'), (2, '继续测试'), (3, '暂停测试'), (4, '跳过步骤')], default=1)),
