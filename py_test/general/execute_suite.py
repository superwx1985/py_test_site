...
class vic_suite:
    ...
    def execute(self):
        ...
        try:
            ...
            # 初始化全局变量, 获取变量组json
            global_variables = vic_variables.Variables(self.logger)
            ...
            if suite.variable_group and suite.variable_group.is_active:
                ...
                v_list = list(
                    suite.variable_group.variable_set.all().values('pk', 'name', 'description', 'value', 'order'))
            ...
            if len(cases) > 0:
                ...
                for case in cases:
                    ...
                    vic_cases.append(
                        VicCase(
                            case=case, suite_result=suite_result, case_order=case_order, user=user,
